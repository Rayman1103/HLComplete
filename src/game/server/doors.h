...
//HL1
#define	SF_DOOR_START_OPEN			131072
#define SF_DOOR_USE_ONLY			262144	// door must be opened by player's use button.
#define SF_DOOR_NOMONSTERS			524288	// Monster can't open
