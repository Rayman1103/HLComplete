...
cvar_t	displaysoundlist_hl1 = {"displaysoundlist_hl1","0"};
...
// multiplayer server rules
cvar_t	teamplay_hl1	= {"mp_teamplay_hl1","0", FCVAR_SERVER };
cvar_t	fraglimit_hl1	= {"mp_fraglimit_hl1","0", FCVAR_SERVER };
cvar_t	timelimit	= {"mp_timelimit","0", FCVAR_SERVER };
cvar_t	friendlyfire_hl1= {"mp_friendlyfire_hl1","0", FCVAR_SERVER };
cvar_t	falldamage_hl1	= {"mp_falldamage_hl1","0", FCVAR_SERVER };
cvar_t	weaponstay_hl1	= {"mp_weaponstay_hl1","0", FCVAR_SERVER };
cvar_t	forcerespawn_hl1= {"mp_forcerespawn_hl1","1", FCVAR_SERVER };
cvar_t	flashlight_hl1	= {"mp_flashlight_hl1","0", FCVAR_SERVER };
cvar_t	aimcrosshair_hl1= {"mp_autocrosshair_hl1","1", FCVAR_SERVER };
cvar_t	decalfrequency_hl1 = {"decalfrequency_hl1","30", FCVAR_SERVER };
cvar_t	teamlist_hl1 = {"mp_teamlist_hl1","hgrunt;scientist", FCVAR_SERVER };
cvar_t	teamoverride_hl1 = {"mp_teamoverride_hl1","1" };
cvar_t	defaultteam_hl1 = {"mp_defaultteam_hl1","0" };
...
void GameDLLInitHL1( void )
{
	...
	CVAR_REGISTER (&displaysoundlist_hl1);

	CVAR_REGISTER (&teamplay_hl1);
	CVAR_REGISTER (&fraglimit_hl1);
	CVAR_REGISTER (&timelimit);

	CVAR_REGISTER (&fragsleft);
	CVAR_REGISTER (&timeleft);

	CVAR_REGISTER (&friendlyfire_hl1);
	CVAR_REGISTER (&falldamage_hl1);
	CVAR_REGISTER (&weaponstay_hl1);
	CVAR_REGISTER (&forcerespawn_hl1);
	CVAR_REGISTER (&flashlight_hl1);
	CVAR_REGISTER (&aimcrosshair_hl1);
	CVAR_REGISTER (&decalfrequency_hl1);
	CVAR_REGISTER (&teamlist_hl1);
	CVAR_REGISTER (&teamoverride_hl1);
	CVAR_REGISTER (&defaultteam_hl1);
