...
#ifndef MONSTER_BASEZOMBIE_H
#define MONSTER_BASEZOMBIE_H
#ifdef _WIN32
#pragma once
#endif
...
//=========================================================
//=========================================================
abstract_class CMonster_BaseZombie : public CAI_BaseZombieBase
{
	DECLARE_CLASS( CMonster_BaseZombie, CAI_BaseZombieBase );

public:
	CMonster_BaseZombie( void );
	~CMonster_BaseZombie( void );
