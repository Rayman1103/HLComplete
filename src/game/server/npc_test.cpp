...
#define TEST_MODEL "models/halflife/barney.mdl"

ConVar	sk_test_health( "sk_test_health","0");

//=========================================================
// Barney activities
//=========================================================

class CNPC_Test : public CNPC_PlayerCompanion
{
public:
	DECLARE_CLASS( CNPC_Test, CNPC_PlayerCompanion );
	DECLARE_SERVERCLASS();
	DECLARE_DATADESC();
...
// 
//---------------------------------------------------------
IMPLEMENT_SERVERCLASS_ST(CNPC_Test, DT_NPC_Test)
END_SEND_TABLE()
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_Test::SelectModel()
{
	SetModelName( AllocPooledString( TEST_MODEL ) );
}
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CNPC_Test::Weapon_Equip( CBaseCombatWeapon *pWeapon )
{
...
//---------------------------------------------------------
//---------------------------------------------------------
void CNPC_Test::HandleAnimEvent( animevent_t *pEvent )
{
	switch( pEvent->event )
	{
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
void CNPC_Test::DeathSound( const CTakeDamageInfo &info )
{
...
bool CNPC_Test::CreateBehaviors( void )
{
...
void CNPC_Test::OnChangeRunningBehavior( CAI_BehaviorBase *pOldBehavior,  CAI_BehaviorBase *pNewBehavior )
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CNPC_Test::GatherConditions()
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void CNPC_Test::UseFunc( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
...
AI_BEGIN_CUSTOM_NPC( npc_test, CNPC_Test )
