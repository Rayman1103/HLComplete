...
LINK_ENTITY_TO_CLASS( soundent_hl1, CSoundEntHL1 );

CSoundEntHL1 *pSoundEnt;

//=========================================================
// CSound - Clear - zeros all fields for a sound
//=========================================================
void CSoundHL1 :: Clear ( void )
{
...
// to the current world time, and these sounds are deallocated.
//=========================================================
void CSoundEntHL1 :: Think ( void )
{
	int iSound;
	int iPreviousSound;

	pev->nextthink = gpGlobalsHL1->time + 0.3;// how often to check the sound list.
...
// Precache - dummy function
//=========================================================
void CSoundEntHL1 :: Precache ( void )
{
}
...
// function for sounds in the Active list!!
//=========================================================
void CSoundEntHL1 :: FreeSound ( int iSound, int iPrevious )
{
	if ( !pSoundEnt )
	{
		// no sound ent!
...
// Active list returns the index of the alloc'd sound
//=========================================================
int CSoundEntHL1 :: IAllocSound( void )
{
	int iNewSound;
...
// sound info.
//=========================================================
void CSoundEntHL1 :: InsertSound ( int iType, const Vector &vecOrigin, int iVolume, float flDuration )
{
	int	iThisSound;
...
// free sound list.
//=========================================================
void CSoundEntHL1 :: Initialize ( void )
{
  	int i;
	int iSound;
...
// sound list.
//=========================================================
int CSoundEntHL1 :: ISoundsInList ( int iListType )
{
	int i;
	int iThisSound;
...
// ActiveList - returns the head of the active sound list
//=========================================================
int CSoundEntHL1 :: ActiveList ( void )
{
	if ( !pSoundEnt )
	{
		return SOUNDLIST_EMPTY;
...
// FreeList - returns the head of the free sound list
//=========================================================
int CSoundEntHL1 :: FreeList ( void )
{
	if ( !pSoundEnt )
	{
		return SOUNDLIST_EMPTY;
...
// of CSound at index's position in the sound pool.
//=========================================================
CSoundHL1*	CSoundEntHL1 :: SoundPointerForIndex( int iIndex )
{
	if ( !pSoundEnt )
	{
		return NULL;
...
// to his reserved sound in the soundlist.
//=========================================================
int CSoundEntHL1 :: ClientSoundIndex ( edict_t *pClient )
{
	int iReturn = ENTINDEX( pClient ) - 1;
