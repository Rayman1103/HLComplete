...
DLL_GLOBAL CGameRulesHL1*	g_pGameRulesHL1 = NULL;
...
//=========================================================
//=========================================================
BOOL CGameRulesHL1::CanHaveAmmo( CBasePlayerHL1 *pPlayer, const char *pszAmmoName, int iMaxCarry )
{
	int iAmmoIndex;
...
//=========================================================
//=========================================================
edict_t_hl1 *CGameRulesHL1 :: GetPlayerSpawnSpot( CBasePlayerHL1 *pPlayer )
{
	edict_t_hl1 *pentSpawnSpot = EntSelectSpawnPoint( pPlayer );

	pPlayer->pev->origin = VARS(pentSpawnSpot)->origin + VectorHL1(0,0,1);
...
//=========================================================
//=========================================================
BOOL CGameRulesHL1::CanHavePlayerItem( CBasePlayerHL1 *pPlayer, CBasePlayerItemHL1 *pWeapon )
{
...
// load the SkillData struct with the proper values based on the skill level.
//=========================================================
void CGameRulesHL1::RefreshSkillData ( void )
{
	int	iSkill;
...
CGameRulesHL1 *InstallGameRulesHL1( void )
{
	...
	else
	{
		...
		if ((int)gpGlobalsHL1->deathmatch == 1)
		{
			// vanilla deathmatch
			g_teamplay = 0;
